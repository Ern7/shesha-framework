...
namespace Shesha.Domain
{
    ...
    [Entity(TypeShortAlias = "Shesha.IO.Core.OrganisationPerson")]
    [DiscriminatorValue("Shesha.IO.Core.OrganisationPerson")]
    [Table("Core_OrganisationPersons")]
    public class OrganisationPerson : OrganisationPersonBase<Organisation, Person>
    {
        [ReferenceList("Shesha.IO.Core", "OrganisationPersonRole")]
