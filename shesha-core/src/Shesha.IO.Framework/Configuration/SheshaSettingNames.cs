namespace Shesha.Configuration
{
    public static class SheshaSettingNames
    {
        ...
        {
            public const string SmsGateway = "Shesha.IO.Application.Sms.SmsGateway";
            public const string RedirectAllMessagesTo = "Shesha.IO.Application.Sms.RedirectAllMessagesTo";
        }
