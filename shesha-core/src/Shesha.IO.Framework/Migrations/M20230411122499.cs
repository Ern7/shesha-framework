...
namespace Shesha.Migrations
{
	...
	where
		...
		and (
			ci.name like 'Shesha.IO.Sms.BulkSms%'
			or ci.name like 'Shesha.IO.Sms.Clickatell%'
			or ci.name like 'Shesha.IO.Sms.SmsPortal%'
			or ci.name like 'Shesha.IO.Sms.Xml2Sms%'
		)
)");
...
where
	...
	and (
		name like 'Shesha.IO.Sms.BulkSms%'
		or name like 'Shesha.IO.Sms.Clickatell%'
		or name like 'Shesha.IO.Sms.SmsPortal%'
		or name like 'Shesha.IO.Sms.Xml2Sms%'
	)");
        }
    }
}
