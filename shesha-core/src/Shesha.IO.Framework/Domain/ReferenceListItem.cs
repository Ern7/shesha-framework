...
{
    [Entity(TypeShortAlias = "Shesha.IO.Framework.ReferenceListItem", GenerateApplicationService = GenerateApplicationServiceState.DisableGenerateApplicationService)]
