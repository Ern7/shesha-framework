...
namespace Shesha.Domain
{
    ...
    /// </summary>
    [Entity(TypeShortAlias = "Shesha.IO.Framework.EntityPropertyValue", GenerateApplicationService = GenerateApplicationServiceState.DisableGenerateApplicationService)]
