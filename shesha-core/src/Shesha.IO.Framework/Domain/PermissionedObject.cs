...
{
    [Entity(TypeShortAlias = "Shesha.IO.Framework.PermissionedObject", GenerateApplicationService = GenerateApplicationServiceState.DisableGenerateApplicationService)]
