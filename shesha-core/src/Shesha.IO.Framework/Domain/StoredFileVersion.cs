...
namespace Shesha.Domain
{
    ...
    /// </summary>
    [Entity(TypeShortAlias = "Shesha.IO.Framework.StoredFileVersion", GenerateApplicationService = GenerateApplicationServiceState.DisableGenerateApplicationService)]
