...
{
    [Entity(TypeShortAlias = "Shesha.IO.Framework.PermissionDefinition", GenerateApplicationService = GenerateApplicationServiceState.DisableGenerateApplicationService)]
