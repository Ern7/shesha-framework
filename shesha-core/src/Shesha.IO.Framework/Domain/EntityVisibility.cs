...
namespace Shesha.Domain
{
    ...
    /// </summary>
    [Entity(TypeShortAlias = "Shesha.IO.Framework.EntityVisibility", GenerateApplicationService = GenerateApplicationServiceState.DisableGenerateApplicationService), Table("Frwk_EntityVisibility")]
    public class EntityVisibility : FullPowerManyToManyLinkEntity
    {
        /// <summary>
        /// Access rights for GrantedToEntityId on EntityId
        /// </summary>
        [MultiValueReferenceList("Shesha.IO.Framework", "EntityAccess")]
