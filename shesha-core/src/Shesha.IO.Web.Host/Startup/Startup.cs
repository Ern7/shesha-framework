...
using Shesha.IO.GraphQL.Middleware;
using Shesha.IO.GraphQL.Swagger;
using Shesha.Identity;
using Shesha.IO.Scheduler.Extensions;
using Shesha.IO.Scheduler.Hangfire;
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(options =>
            {
                ...
                options.IndexStream = () => Assembly.GetExecutingAssembly()
                    .GetManifestResourceStream("Shesha.IO.Web.Host.wwwroot.swagger.ui.index.html");
            }); // URL: /swagger
