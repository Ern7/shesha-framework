...
namespace Shesha.IO.Web.FormsDesigner.Migrations
{
    ...
    public class M20221229135599 : OneWayMigration
    {
        public override void Up()
        {
            ...
            Execute.Sql("delete from Frwk_ConfigurableComponents where Frwk_Discriminator = 'Shesha.IO.Framework.Form'");
...
where
	Frwk_Discriminator = 'Shesha.IO.Framework.ConfigurableComponent'
	and not exists (select 1 from Frwk_ConfigurationItems where Id = Frwk_ConfigurableComponents.Id)
");

            // Shesha.IO.Web.FormsDesigner.Domain.FormConfiguration
